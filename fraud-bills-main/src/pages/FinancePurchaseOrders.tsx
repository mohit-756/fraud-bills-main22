      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Create and manage purchase orders — review vendor quotes and approve.
          </p>
        </div>
...
<div className="flex items-center gap-2">
  <input
    ...
    className="border rounded-md px-3 py-1.5 text-sm w-80 bg-background focus:outline-none focus:ring-1 focus:ring-ring"
  />
  <select
    value={statusFilter}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-muted-foreground">
                    ...
                    <th className="text-right py-2 pr-4 font-medium">Vendor Quote Total</th>
                      ...
                      <td className="py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <Button
                            ...
                            onClick={() => { setPreview(order); setPreviewOpen(true); }}
                          >
                            <Eye className="h-3.5 w-3.5" />
                          </Button>

                          {/* Accept / Reject — only for accepted (quote received) POs */}
